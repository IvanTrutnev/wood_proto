        ...
        <div class="search-form">
            <div class="search-form__filters">
                <div>
                    ...
                    <multiselect v-model="searchData.user.value" :max-height="200" :show-labels="false"
                                 placeholder="Search a tag" label="username" track-by="username"
                                 :options="searchData.user.options" :multiple="true" :taggable="true"></multiselect>
                </div>
                <div>
                    <label class="typo__label">Buyer</label>
                    <multiselect v-model="searchData.partner.value" :max-height="200" :show-labels="false"
                                 placeholder="Search a tag" label="text" track-by="text"
                ...
                <div>
                    <a href="http://localhost:3000/sale/orderProducts">Test</a>
                </div>
                <div>
